# Bryan's Objective-C Style Guide

This style guide covers the coding conventions of several iOS teams. These conventions are all snippets from the following:

* [NYT Style Guide](https://github.com/NYTimes/objective-c-style-guide/blob/master/README.md)
* [Ray Wenderlich Style Guide](https://github.com/raywenderlich/objective-c-style-guide#methods)
* [Advice from jverkoey](https://github.com/jverkoey/iOS-Best-Practices)
